---
title: "Medicine is the Floor, not the Ceiling"
description: "Thoughts on Value Creation in Healthcare"
dateString: 19th May 2026
draft: false
tags: ["featured"]
showToc: false
weight: 101
...
1. The first is the **clinical pathway**: direct patient care. This remains the core of medicine. It is where trust is built, suffering is relieved, and decisions directly change the lives of individual patients.
2. The second is the **research pathway**: generating new knowledge. Research changes what medicine understands, measures, and treats. Its greatest impact often comes when discoveries are translated into practice, therapeutics, diagnostics, or new models of care.
3. The third is the **technical pathway**: building tools. This includes software, hardware, AI systems, drugs, devices, and infrastructure. These can raise the standard of care not just for one patient, but for entire systems.
4. The fourth is the **policy pathway**: changing how healthcare is organised, funded, and delivered. In a world of finite resources, better coordination, incentives, and institutional design can create enormous value at population scale.
5. The fifth is the **media pathway**: moving information. Healthcare is an information system as much as a biological one. Helping patients, clinicians, and organisations understand what matters can shape decisions far beyond the clinic.
